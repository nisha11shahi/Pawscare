                ...
                <div class="col-md-10 col-md-offset-1">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group address">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input type="text" class="form-control" id="inputAddress" name="inputAddress" placeholder="Enter Address">
                  </div>
              </div>
              <div class="form-group ">
                <label class="control-label" for="inputSuccess1">Why do you want to adopt?</label>
                <textarea class="form-control" rows="5" id="inputwhy" name="inputwhy"></textarea> 
            </div>
